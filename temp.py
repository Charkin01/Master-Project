...
# Define the model architecture (example using a BERT-based QA model)
model = TFBertForQuestionAnswering.from_pretrained('bert-base-uncased')

# Load the weights from the H5 file
model.load_weights(r'C:\Users\chirk\Downloads\Python\Master-Project\trained_model\sq_clean\tf_model.h5')
